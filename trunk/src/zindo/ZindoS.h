...
private:
   ...
   void FreeDavidsonCISTmpMatrices(double*** expansionVectors, 
                                   double** residualVector, 
                                   double** ritzVector) const;
   void FreeDavidsonRoopCISTmpMatrices(double*** interactionMatrix, 
                                       int interactionMatrixDimension, 
   ...
   double GetZMatrixForceElement(double const* y,
                                 ...
                                 int mu, 
                                 int nu) const;
   void MallocTmpMatrixForZMatrix(double** delta,
                                  double** q,
                                  ...
                                  int sizeQNR,
                                  int sizeQR) const;
   void FreeTmpMatrixForZMatrix(double** delta,
                                double** q,
                                double*** gammaNRMinusKNR, 
                                double*** kRDag,
                                double** y,
