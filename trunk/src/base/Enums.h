...
RENUMSTR_BEGIN( AtomType, AtomTypeStr )
   ...
   RENUMSTR( Cl,   "Cl" )
   RENUMSTR( Ar,   "Ar" )
   RENUMSTR( bqH,  "ghost-H" )
   RENUMSTR( bqHe, "ghost-He" )
   RENUMSTR( bqLi, "ghost-Li" )
   RENUMSTR( bqBe, "ghost-Be" )
   RENUMSTR( bqB,  "ghost-B" )
   RENUMSTR( bqC,  "ghost-C" )
   RENUMSTR( bqN,  "ghost-N" )
   RENUMSTR( bqO,  "ghost-O" )
   RENUMSTR( bqF,  "ghost-F" )
   RENUMSTR( bqNe, "ghost-Ne" )
   RENUMSTR( bqNa, "ghost-Na" )
   RENUMSTR( bqMg, "ghost-Mg" )
   RENUMSTR( bqAl, "ghost-Al" )
   RENUMSTR( bqSi, "ghost-Si" )
   RENUMSTR( bqP,  "ghost-P" )
   RENUMSTR( bqS,  "ghost-S" )
   RENUMSTR( bqCl, "ghost-Cl" )
   RENUMSTR( bqAr, "ghost-Ar" )
