...
void Oatom::SetAtomicParameters(){
   ...
   this->rm1CoreintegralS = -96.94948069 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1CoreintegralP = -77.89092978 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1OrbitalExponentS = 3.17936914;
   this->rm1OrbitalExponentP = 2.55361907;
   this->rm1BondingParameterS = -29.85101212 * Parameters::GetInstance()->GetEV2AU();
   this->rm1BondingParameterP = -29.15101314 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Alpha = 4.17196717  / Parameters::GetInstance()->GetAngstrom2AU();    
   this->rm1Gss = 14.00242788 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp = 14.95625043 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gsp = 14.14515138 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp2 =12.70325497 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Hsp = 3.93217161  * Parameters::GetInstance()->GetEV2AU();
   this->rm1DerivedParameterD[0] = 0;    
   this->rm1DerivedParameterD[1] = 0.4886700608;    
   this->rm1DerivedParameterD[2] = 0.4796114212;    
   this->rm1DerivedParameterRho[0] = 0.5/0.5145756422;     
   this->rm1DerivedParameterRho[1] = 0.5/1.0065570000;     
   this->rm1DerivedParameterRho[2] = 0.5/1.0332202634;    
   this->rm1ParameterK[0] = 0.23093552 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[1] = 0.05859873 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[2] = 0.0 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[3] = 0.0 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterL[0] = 5.21828736 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[1] = 7.42932932 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   ...
   this->rm1ParameterM[0] = 0.90363555* Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[1] = 1.5175461 * Parameters::GetInstance()->GetAngstrom2AU();
