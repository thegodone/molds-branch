...
void Clatom::SetAtomicParameters(){
   ...
   this->rm1CoreintegralS = -118.4730692 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1CoreintegralP = -76.3533034 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1OrbitalExponentS = 3.86491071;
   this->rm1OrbitalExponentP = 1.89593144;
   this->rm1BondingParameterS = -19.92430432 * Parameters::GetInstance()->GetEV2AU();
   this->rm1BondingParameterP = -11.52935197 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Alpha = 3.69358828 / Parameters::GetInstance()->GetAngstrom2AU();    
   this->rm1Gss = 15.36023105 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp = 13.30671171 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gsp = 12.5650264  * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp2 = 9.66397083 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Hsp = 1.76489897  * Parameters::GetInstance()->GetEV2AU();
   this->rm1DerivedParameterD[0] = 0;    
   this->rm1DerivedParameterD[1] = 0.4541788491;    
   this->rm1DerivedParameterD[2] = 0.8825846852;    
   this->rm1DerivedParameterRho[0] = 0.5/0.5644735917;     
   this->rm1DerivedParameterRho[1] = 0.5/0.7489561728;     
   this->rm1DerivedParameterRho[2] = 0.5/0.8475391920;     
   this->rm1ParameterK[0] = 0.12947108 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[1] = 0.00288899 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[2] = 0 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[3] = 0 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterL[0] = 2.97724424 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[1] = 7.09827589 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[2] = 0 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[3] = 0 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterM[0] = 1.46749784 * Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[1] = 2.50002723 * Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[2] = 0 * Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[3] = 0 * Parameters::GetInstance()->GetAngstrom2AU();
   ...
   this->pm3PddgCoreintegralS = -95.094434 * Parameters::GetInstance()->GetEV2AU();         
   this->pm3PddgCoreintegralP = -53.921651 * Parameters::GetInstance()->GetEV2AU();         
   this->pm3PddgOrbitalExponentS = 2.548268;      
   this->pm3PddgOrbitalExponentP = 2.284624;      
   this->pm3PddgBondingParameterS = -26.913129 * Parameters::GetInstance()->GetEV2AU();     
   this->pm3PddgBondingParameterP = -14.991178 * Parameters::GetInstance()->GetEV2AU();     
   this->pm3PddgAlpha = 2.497617 / Parameters::GetInstance()->GetAngstrom2AU();        
   ...
   this->pm3PddgParameterK[0] =-0.112222 * Parameters::GetInstance()->GetEV2AU();
   this->pm3PddgParameterK[1] =-0.013061 * Parameters::GetInstance()->GetEV2AU();
   this->pm3PddgParameterK[2] = 0.0;
   this->pm3PddgParameterK[3] = 0.0;
   this->pm3PddgParameterL[0] = 5.963719 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->pm3PddgParameterL[1] = 1.999556 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->pm3PddgParameterL[2] = 0.00;
   this->pm3PddgParameterL[3] = 0.00;
   this->pm3PddgParameterM[0] = 1.027719 * Parameters::GetInstance()->GetAngstrom2AU();
   this->pm3PddgParameterM[1] = 2.286377 * Parameters::GetInstance()->GetAngstrom2AU();
   this->pm3PddgParameterM[2] = 0.00;
   this->pm3PddgParameterM[3] = 0.00;
   this->pm3PddgParameterPa[0] =-0.016552 * Parameters::GetInstance()->GetEV2AU();
   this->pm3PddgParameterPa[1] =-0.016646 * Parameters::GetInstance()->GetEV2AU();
   this->pm3PddgParameterDa[0] = 1.727690 * Parameters::GetInstance()->GetAngstrom2AU();
   this->pm3PddgParameterDa[1] = 1.784655 * Parameters::GetInstance()->GetAngstrom2AU();
