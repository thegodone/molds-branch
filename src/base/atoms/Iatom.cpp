...
void Iatom::SetAtomicParameters(){
   ...
   this->pm3Gss = 13.6319430 * Parameters::GetInstance()->GetEV2AU();
   this->pm3Gpp = 7.2883300  * Parameters::GetInstance()->GetEV2AU();
   this->pm3Gsp = 14.9904060  * Parameters::GetInstance()->GetEV2AU();
   this->pm3Gpp2 = 5.9664070  * Parameters::GetInstance()->GetEV2AU();
   this->pm3Hsp = 2.6300350   * Parameters::GetInstance()->GetEV2AU();
   this->pm3DerivedParameterD[0] = 0.0;    
   this->pm3DerivedParameterD[1] = 0.1581465591;    
   this->pm3DerivedParameterD[2] = 1.0467319314;    
   this->pm3DerivedParameterRho[0] = 0.5/0.5009606823;
   this->pm3DerivedParameterRho[1] = 0.5/1.6698761025;  
   this->pm3DerivedParameterRho[2] = 0.5/0.5152969528;  
   ...
   this->pm3PddgDerivedParameterD[1] = 0.4072615047;
   this->pm3PddgDerivedParameterD[2] = 1.0625743264;
   this->pm3PddgDerivedParameterRho[0] = 0.5/0.5009606823;
   this->pm3PddgDerivedParameterRho[1] = 0.5/0.9393151562;
   this->pm3PddgDerivedParameterRho[2] = 0.5/0.5103060416;
