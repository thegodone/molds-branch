...
void Fatom::SetAtomicParameters(){
   ...
   this->rm1CoreintegralS = -134.1836959 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1CoreintegralP = -107.8466092 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1OrbitalExponentS = 4.40337913;
   this->rm1OrbitalExponentP = 2.64841556;
   this->rm1BondingParameterS = -70.00000512 * Parameters::GetInstance()->GetEV2AU();
   this->rm1BondingParameterP = -32.67982711 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Alpha = 6.00000062  / Parameters::GetInstance()->GetAngstrom2AU();    
   this->rm1Gss = 16.72091319 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp = 16.76142629 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gsp = 15.22581028 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp2 = 14.86578679 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Hsp = 1.99766171  * Parameters::GetInstance()->GetEV2AU();
   this->rm1DerivedParameterD[0] = 0;    
   this->rm1DerivedParameterD[1] = 0.3488927336;    
   this->rm1DerivedParameterD[2] = 0.4624443724;    
   this->rm1DerivedParameterRho[0] = 0.5/0.6144773404;     
   this->rm1DerivedParameterRho[1] = 0.5/0.9225280329;     
   this->rm1DerivedParameterRho[2] = 0.5/1.0005621127;     
   this->rm1ParameterK[0] = 0.40302025 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[1] = 0.07085831 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[2] = 0.0 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[3] = 0.0 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterL[0] = 7.20441959 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[1] = 9.00001562 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   ...
   this->rm1ParameterM[0] = 0.81653013 * Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[1] = 1.43802381 * Parameters::GetInstance()->GetAngstrom2AU();
   ...
   this->pm3PddgCoreintegralS = -111.400432 * Parameters::GetInstance()->GetEV2AU();         
   this->pm3PddgCoreintegralP = -106.395264 * Parameters::GetInstance()->GetEV2AU();
   this->pm3PddgOrbitalExponentS = 5.538033;      
   this->pm3PddgOrbitalExponentP = 2.538066;      
   this->pm3PddgBondingParameterS = -50.937301 * Parameters::GetInstance()->GetEV2AU();     
   this->pm3PddgBondingParameterP =  -31.636976 * Parameters::GetInstance()->GetEV2AU();
   this->pm3PddgAlpha = 31.636976 / Parameters::GetInstance()->GetAngstrom2AU();        
   ...
   this->pm3PddgParameterK[0] = -0.008079 * Parameters::GetInstance()->GetEV2AU();
   this->pm3PddgParameterK[1] = -0.002659 * Parameters::GetInstance()->GetEV2AU();
   this->pm3PddgParameterK[2] = 0.0;
   this->pm3PddgParameterK[3] = 0.0;
   this->pm3PddgParameterL[0] = 5.938969 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->pm3PddgParameterL[1] = 5.925105 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->pm3PddgParameterL[2] = 0.00;
   this->pm3PddgParameterL[3] = 0.00;
   this->pm3PddgParameterM[0] = 1.863949 * Parameters::GetInstance()->GetAngstrom2AU();
   this->pm3PddgParameterM[1] = 2.388864 * Parameters::GetInstance()->GetAngstrom2AU();
   this->pm3PddgParameterM[2] = 0.00;
   this->pm3PddgParameterM[3] = 0.00;
   this->pm3PddgParameterPa[0] =-0.012866 * Parameters::GetInstance()->GetEV2AU();
   this->pm3PddgParameterPa[1] = 0.007315 * Parameters::GetInstance()->GetEV2AU();
   this->pm3PddgParameterDa[0] = 1.305681 * Parameters::GetInstance()->GetAngstrom2AU();
   this->pm3PddgParameterDa[1] = 1.842572 * Parameters::GetInstance()->GetAngstrom2AU();
