...
void Natom::SetAtomicParameters(){
   ...
   this->rm1CoreintegralS = -70.85123715 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1CoreintegralP = -57.9773092 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1OrbitalExponentS = 2.37447159;
   this->rm1OrbitalExponentP = 1.97812569;
   this->rm1BondingParameterS = -20.87124548 * Parameters::GetInstance()->GetEV2AU();
   this->rm1BondingParameterP = -16.67171853 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Alpha = 2.96422542  / Parameters::GetInstance()->GetAngstrom2AU();    
   this->rm1Gss = 13.08736234 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp = 13.21226834 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gsp = 13.69924324 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp2 =11.94103953 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Hsp = 5.00000846  * Parameters::GetInstance()->GetEV2AU();
   this->rm1DerivedParameterD[0] = 0;
   this->rm1DerivedParameterD[1] = 0.6495619690;
   this->rm1DerivedParameterD[2] = 0.6191441108;
   this->rm1DerivedParameterRho[0] = 0.5/0.4809478713;
   this->rm1DerivedParameterRho[1] = 0.5/0.9705986481;
   this->rm1DerivedParameterRho[2] = 0.5/0.7221179396;
   this->rm1ParameterK[0] = 0.0607338 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[1] = 0.02438558 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[2] = -0.0228343 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[3] = 0  * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterL[0] = 4.58892946 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[1] = 4.62730519 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[2] = 2.05274659 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[3] = 0 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterM[0] = 1.37873881 * Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[1] = 2.08370698 * Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[2] = 1.86763816 * Parameters::GetInstance()->GetAngstrom2AU();
