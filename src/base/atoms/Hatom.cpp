...
void Hatom::SetAtomicParameters(){
   ...
   this->rm1CoreintegralS = -11.96067697 * Parameters::GetInstance()->GetEV2AU();
   this->rm1CoreintegralP = 0.0;
   this->rm1OrbitalExponentS = 1.08267366;
   this->rm1OrbitalExponentP = 0.0;
   this->rm1BondingParameterS =  -5.76544469  * Parameters::GetInstance()->GetEV2AU();
   this->rm1BondingParameterP = 0.0;
   this->rm1Alpha = 3.06835947  / Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1Gss = 13.98321296 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp = 0.0 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gsp = 0.0 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp2 =0.0 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Hsp = 0.0 * Parameters::GetInstance()->GetEV2AU();
   this->rm1DerivedParameterD[0] =  0.0;
   this->rm1DerivedParameterD[1] =  0.0;
   this->rm1DerivedParameterD[2] =  0.0;
   this->rm1DerivedParameterRho[0] = 0.5/0.5138695126;
   this->rm1DerivedParameterRho[1] = 0.0;
   this->rm1DerivedParameterRho[2] = 0.0;
   this->rm1ParameterK[0] =   0.10288875  * Parameters::GetInstance()->GetEV2AU();     
   this->rm1ParameterK[1] =   0.06457449  * Parameters::GetInstance()->GetEV2AU();     
   this->rm1ParameterK[2] =   -0.03567387 * Parameters::GetInstance()->GetEV2AU();     
   this->rm1ParameterK[3] =  0.00000  * Parameters::GetInstance()->GetEV2AU();     
   this->rm1ParameterL[0] =   5.90172268   / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);    
   this->rm1ParameterL[1] =   6.41785671   / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);    
   this->rm1ParameterL[2] =   2.80473127   / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);    
   this->rm1ParameterL[3] =  0.0   / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);    
   this->rm1ParameterM[0] =  1.17501185  * Parameters::GetInstance()->GetAngstrom2AU();     
   this->rm1ParameterM[1] =  1.93844484  * Parameters::GetInstance()->GetAngstrom2AU();     
   this->rm1ParameterM[2] =   1.63655241  * Parameters::GetInstance()->GetAngstrom2AU();     
