...
void Satom::SetAtomicParameters(){
   ...
   */
   ...
   this->rm1CoreintegralS = -55.16775121 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1CoreintegralP = -46.52930422 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1OrbitalExponentS = 2.13344308;
   this->rm1OrbitalExponentP = 1.8746065;
   this->rm1BondingParameterS = -1.95910719 * Parameters::GetInstance()->GetEV2AU();
   this->rm1BondingParameterP = -8.77430652 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Alpha = 2.44015636 / Parameters::GetInstance()->GetAngstrom2AU();    
   this->rm1Gss = 12.48828408 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp =  8.56910574 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gsp =  8.52301167 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp2 = 7.66863296 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Hsp =  3.88978932 * Parameters::GetInstance()->GetEV2AU();
   this->rm1DerivedParameterD[0] = 0;    
   this->rm1DerivedParameterD[1] = 0.9936920779;    
   this->rm1DerivedParameterD[2] = 0.8926246938;    
   this->rm1DerivedParameterRho[0] = 0.5/0.4589323263;     
   this->rm1DerivedParameterRho[1] = 0.5/0.6930723227;     
   this->rm1DerivedParameterRho[2] = 0.5/0.5042133641;     
   this->rm1ParameterK[0] = -0.74601055 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[1] = -0.06519286 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[2] = -0.00655977 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[3] = 0.0 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterL[0] = 4.81038002 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[1] = 7.20760864 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[2] = 9.0000018  / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[3] = 0.0 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterM[0] = 0.59380129 * Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[1] = 1.29492008 * Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[2] = 1.80060151 * Parameters::GetInstance()->GetAngstrom2AU();
