...
void Catom::SetAtomicParameters(){
   ...
   this->rm1CoreintegralS = -51.72556032 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1CoreintegralP = -39.40728943 * Parameters::GetInstance()->GetEV2AU();    
   this->rm1OrbitalExponentS = 1.85018803;
   this->rm1OrbitalExponentP = 1.76830093;
   this->rm1BondingParameterS = -15.45932428 * Parameters::GetInstance()->GetEV2AU();
   this->rm1BondingParameterP = -8.23608638  * Parameters::GetInstance()->GetEV2AU();
   this->rm1Alpha = 2.79282078 / Parameters::GetInstance()->GetAngstrom2AU();    
   this->rm1Gss = 13.0531244 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp = 11.33479389 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gsp = 10.95113739 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Gpp2 = 9.72395099 * Parameters::GetInstance()->GetEV2AU();
   this->rm1Hsp = 1.55215133 * Parameters::GetInstance()->GetEV2AU();
   this->rm1DerivedParameterD[0] = 0;
   this->rm1DerivedParameterD[1] = 0.7967571130;
   this->rm1DerivedParameterD[2] = 0.6926111108;
   this->rm1DerivedParameterRho[0] = 0.5/0.4796896602;
   this->rm1DerivedParameterRho[1] = 0.5/0.7323971678;
   this->rm1DerivedParameterRho[2] = 0.5/0.7231909336;
   this->rm1ParameterK[0] = 0.07462271 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[1] = 0.01177053 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[2] = 0.03720662 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterK[3] = -0.00270657 * Parameters::GetInstance()->GetEV2AU();
   this->rm1ParameterL[0] = 5.73921605 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[1] = 6.92401726 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[2] = 6.26158944 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterL[3] = 9.00003735 / pow(Parameters::GetInstance()->GetAngstrom2AU(),2.0);
   this->rm1ParameterM[0] = 1.04396983 * Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[1] = 1.66159571 * Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[2] = 1.63158721 * Parameters::GetInstance()->GetAngstrom2AU();
   this->rm1ParameterM[3] = 2.79557901 * Parameters::GetInstance()->GetAngstrom2AU();
